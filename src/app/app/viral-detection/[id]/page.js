...
export default function BlogDetail() {
  ...
  return (
    <div className='w-full h-full overflow-hidden pt-[32px] flex flex-col'>
          <div className='flex px-[24px] pb-[20px] items-start'>
            <div className='flex gap-[16px] flex-col md:flex-row flex-1 items-start md:items-center justify-center md:justify-start'>
