...
import AboutUsIcon from "@/assets/icons/about.svg";
            ...
            <div className="flex flex-col">
                ...
                <div className='flex-1 flex flex-col items-center p-4 md:p-6 lg:p-8 py-6 md:py-8'>
                    ...
                    <div className="w-full flex flex-col items-center justify-center mt-8 md:mt-[50px] px-4">
                        <div className="rounded-full flex gap-2 mb-4 md:mb-[23px] bg-[#F8F9FD] px-4 py-2 items-center justify-center font-[500] text-[12px] text-[#2B425B]">
                            <AboutUsIcon width={10} height={10} />
                            About Us
                        </div>
