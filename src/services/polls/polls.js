  ...
  try {
      const response = await fetch(url, {
          ...
          body: JSON.stringify({
                  ...
                  "input": `Please create a poll with the topic: "${topic}" using one current news article from one of the following sources ONLY: The Weather Channel, BBC News, PBS NewsHour, Associated Press (AP), Reuters, NPR, Financial Times, Wall Street Journal, ABC News (Australia), CBC News (Canada), Bloomberg, Agence France-Presse (AFP), Deutsche Presse-Agentur (dpa), ProPublica, or Mongabay. Articles and polls should never reference old content; they must use the latest ones that are posted from 2025 and beyond.\n\nContent structure:\n1. Add a one-sentence **headline** summarizing the article in your own words. DO NOT mention the news outlet by name (e.g., “Reuters reports” is not allowed). Add news source with parathesis to the end. e.g. (AP News, publisher verified)\n2. Write a **balanced poll question** informed by the article’s topic.\n3. Provide **2 to 4 answer options**.\n4. Include a **wiki_summary** explaining the core subject using only Wikipedia-style information. Do not reference the article in this section.\n5. Write a **blog_title** that is clear and compelling.\n6. Write a **blog_content** of 250–500 words. Use only Wikipedia for your reference to write these blogs as it is open source. It must offer original analysis, global comparisons, or implications based on publicly known facts or open data. DO NOT summarize, paraphrase, or rewrite the article. DO NOT end with a question.\n\nImportant Notes:\n- Stick strictly to the approved source list.\n- Blog content should reflect professional analysis, not casual commentary.\n- Maintain a neutral, journalistic tone — no speculation or editorializing.
${previous_headlines}`,
                  "text": { 
                      "format": { 
                          "name": "poll",
