...
const Blog = ({ blog }) => {
  ...
  return (
    <div
      className="rounded-[12px] border border-secondary shadow-xs flex flex-col p-[16px] gap-[11px] md:gap-[20px] md:px-[24px] md:py-[17px] w-full bg-white cursor-pointer"
    ...
    >
      <div className="flex w-full gap-[8px] items-center w-full">
        ...
        {blog.topic ? (
          <div className="rounded-full bg-[#5856D6] w-[114px] h-[22px] flex items-center justify-center text-white">
