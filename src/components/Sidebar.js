      ...
      <div className="flex flex-col gap-[24px] pt-[32px] ">
        ...
        <div className="flex flex-col px-[16px] gap-[4px]">
          ...
          <Link
            ...
            className={
              "rounded-[12px] py-[8px] px-[12px] flex items-center w-full gap-[12px] " +
              (pathname == "/trending" ? "bg-blue  text-white" : "")
            }
          >
      ...
      {user && (
        <div className="flex flex-col gap-[20px]">
          {(!user.subscripted_at || user.subscripted_at < Date.now()) && (
            <div className="p-[12px] w-full">
              <div className="rounded-[12px] p-[16px] border border-secondary w-full gap-[8px] flex flex-col">
                ...
                <Link
                  href="/subscription"
                  className=" w-full text-center rounded-[8px] bg-blue text-white w-full p-[8px]"
                >
                  Upgrade Now
                </Link>
              </div>
          ...
          <div className="flex items-center gap-[10px] justify-center px-[20px] mx-[10px] border rounded-full">
            ...
            <Link
              href="/profile"
              className="flex flex-1 flex-col border-x px-[14px] justify-center items-center"
            >
