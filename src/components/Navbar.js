...
export default function Navbar() {
  ...
  return (
    <div className="flex p-4 md:hidden items-center h-[60px] w-full border-b border-[#E4E7EC]">
      ...
      {show && (
        <div className="fixed left-0 top-[60px] bottom-0 right-0 bg-[#000000cc] flex border-t z-[1]">
              ...
              {user && (
                <div className="flex flex-col gap-[20px]">
                  ...
                  <div className="flex items-center gap-[10px] justify-center px-[20px] mx-[10px] border rounded-full">
                    <Link
                      href="/profile"
                      className="flex flex-1 flex-col border-r px-[14px] justify-center items-center"
                    >
